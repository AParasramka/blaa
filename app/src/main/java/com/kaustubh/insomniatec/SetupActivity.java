...
//                alarm_point_txt.setText(getString(R.string.seekbar_tracking_off));
            }

            @Override
            public void onStartTrackingTouch(SeekBar seekBar) {
//                alarm_point_txt.setText(getString(R.string.seekbar_tracking_on));
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                alarm_point_txt.setText(String.valueOf(progress));
                Constants.ALARM_POINT=progress;
                alarm_point_txt.setText(Constants.ALARM_POINT+"");
//                System.out.println(alarm_point_txt.setText(String.valueOf(progress)));
            }
        };
